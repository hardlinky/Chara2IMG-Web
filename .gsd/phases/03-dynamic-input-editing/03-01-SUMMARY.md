...
tags: [inputs, workflow, parsing, ordering, drafts]
requires:
  - phase: 02-02
    provides: Active template persistence and restore flow
provides:
  - Workflow-derived typed input control catalog with deterministic ordering
...
tech-stack:
  added: []
  patterns: [metadata-driven input typing, default-order-plus-overlay, black-box workflow editing]
key-files:
...
key-decisions:
  ...
  - Keep control typing metadata-driven through node __input declarations
...
- Implemented deterministic deriveInputControls parsing with strict [Input#] conventions, warning emission, and stable ordering.
